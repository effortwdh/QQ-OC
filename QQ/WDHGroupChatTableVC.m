...
@interface WDHGroupChatTableVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation WDHGroupChatTableVC
- (void)initDataSource
{
    _sectionArray  = [NSMutableArray arrayWithObjects:@"置顶群聊",
                     @"未命名群聊",
                     @"我创建的群聊",
                     @"我管理的群聊",
                     @"我加入的群聊",
                      nil];
    _onlineNumber  = [NSMutableArray arrayWithObjects:@"20",
                     @"30",
                     @"19",
                     @"2",@"23/32",nil];
    ...
    NSArray *five = @[@"同学一",@"同学二",@"同学三",@"同学四",@"同学五"];
    
    _dataSource = [NSMutableArray arrayWithObjects:one,two,three,four,five, nil];
